...
while (guestList2.length > 2) {
  let removedGuest: string = guestList2.pop()!;
  console.log(`Sorry ${removedGuest}, I can't invite you to dinner.`);
}

// Print a message to each of the two remaining guests
for (let guest of guestList2) {
  let message: string = `Dear ${guest}, you are still invited to dinner at my place on Saturday evening. Please let me know if you can make it. Sincerely, [Mohsin Khan]`;
  console.log(message);
}
