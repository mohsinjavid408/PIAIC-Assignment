let guestList = ["ali", "asim", "osman"];

for (let guest of guestList) {
  let message: string = `Dear ${guest}, you are cordially invited to dinner at my place on Saturday evening. Please let me know if you can make it. Sincerely, [Mohsin khan]`;
  console.log(message);
}
